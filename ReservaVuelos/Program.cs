...
namespace ReservaVuelos
{
    ...
    //Definimos una estructura para representar la informacion del cliente
    struct Cliente
    {
        //Campos 
        string nombre;
    ...
    class CompraBoletos
    {
        ...
        public void Reservacion()
        {
            ...
            //Creamos un objeto cliente para poder guardar su informacion
            Cliente cliente = new Cliente();
            // Pedimos la informacion del cliente
            Console.WriteLine("Ingrese la info que se le pide a continuacion\n");
        ...
        public void SeleccionarDestino()
        {
            ...
            Console.WriteLine("Seleccione un destino (numero):");
        ...
        public void SeleccionarHorario()
        {
            ...
            Console.WriteLine("Seleccione un horario (numero): ");
        ...
        public void SeleccionarSeccion()
        {
            ...
            Console.Write("Seleccione la seccion de su preferencia (numero): ");
            ...
            switch (opcionSeccion)
            {
                case 1:
                    ...
                    break;
                default:
                    Console.WriteLine("Secion no valida");
                    break;
...

        {
            ...
            Console.Write("Seleccione el tipo de asiento de su preferencia (numero): ");
        ...
        public void ResumenReservacion(Cliente cliente)
        {
            ...
            Console.WriteLine($"Numero de cedula: {cliente.Id}");
            ...
            Console.WriteLine("\nConfirme su reserva (Presiones cualquier tecla para confirmar): ");
            Console.ReadKey();
